...
function Spanel(){
   ...
   <View style={styles.cont2}>
     <View style={styles.cont1}>
        ...
        <Text style={styles.txt1}>Lowest Price</Text>
     </View>
     ...
     <View style={styles.cont1}>
        ...
        <Text style={styles.txt1}>Next Day Dispatch</Text>
     </View></View>
...
/* <View style={styles.cont3}>
        ...
        <Image  style={styles.img1} source={require('../../assets/cod1.png')}  ></Image>
        <Text style={styles.txt2}>Cash on Delievery</Text>
     </View>  */